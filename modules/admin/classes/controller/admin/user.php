    ...
    public function action_index()
    {
       // Load the user information
        ...
        if (!$user)
        {
	        ...
	        $this->template->content_for_layout = View::factory('admin/user/home');
			$this->template->site_area = "Home";
		}
    }
 
    public function action_create() 
    {
		$this->template = View::factory('layouts/login');
        $this->template->content_for_layout = View::factory('admin/user/create')
            ->bind('errors', $errors)
